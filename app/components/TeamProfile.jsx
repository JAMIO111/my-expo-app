    ...
    <ScrollView className=" flex-1 bg-bg-1" contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View className=" w-full flex-row items-center justify-start gap-6 border-b border-separator bg-bg-grouped-2 pl-5">
        ...
        <View className="max-w-full py-5">
          <Text className="max-w-xs text-3xl font-extrabold text-text-1">{player?.team?.name}</Text>
      ...
      <View className="gap-5 bg-bg-grouped-1 px-3 pb-12 pt-6">
        ...
        <View className="">
          <Heading text="Roster" />
          <PlayersList team={player.team} context={context} />
        </View>
      </View>
    </ScrollView>
  );
